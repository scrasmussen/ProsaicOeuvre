...
* Knowledge
** [Boston marriage]                                                  :drill:
  :PROPERTIES:
  :END:
historically, the cohabitation of two wealthy women, independent of financial
support from a man. The term is said to have been in use in New England in the
late 19th/early 20th century. Some of these relationships were romantic in
nature and might now be considered a lesbian relationship; others were not.
** [spoonerism]                                                       :drill:
  :PROPERTIES:
  :END:
an error in speech in which corresponding consonants, vowels, or morphemes are
switched between two words in a phrase.
** [malapropism]                                                      :drill:
  :PROPERTIES:
  :END:
The mistaked use of an incorrect word in place of a word with a similar sound.

** [patina]                                                           :drill:
  :PROPERTIES:
  :END:
1. a usually green film on top of something
2. an appearance or aura that is derived from association, habit, or
   established character
3. a superficial covering or exterior

** [Götterdämmerung]                                                  :drill:
  :PROPERTIES:
  :END:
[Götterdämmerung]: a collapse (as of a society or regime) marked by
catastrophic violence and disorder

** [nom de guerre]                                                    :drill:
  :PROPERTIES:
  :END:
[nom de guerre]: an assumed name under which a person engages in combat or
some other activity or enterprise
** [anomie]                                                           :drill:
  :PROPERTIES:
  :END:
[anomie]: social instability resulting from a breakdown of standards and
values.
Also: personal unrest, alienation, and uncertainty that comes from a lack of
purpose or ideals

** [Laconic phase]                                                    :drill:
  :PROPERTIES:
  :ID:       F9A5772C-B3B3-434A-9DBE-0FAD5C9E8E01
  :END:
...
** [parvenu]                                                          :drill:
  :PROPERTIES:
  :ID:       F9CCA949-C3C6-4D12-8F2A-A5AE7C540F8B
  :END:
